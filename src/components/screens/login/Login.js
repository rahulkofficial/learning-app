  ...
  export default function Login({ navigation }) {
    ...
    return (
      <SafeAreaView style={{flex:1,alignItems:"center",paddingTop:100,backgroundColor:"#fff"}}>
        ...
        <View>
          <Text style={{color:"#000",fontSize:28,fontFamily:"DMSans-Medium",marginTop:50,textAlign:"center"}}>Login to your account</Text>
          <Text style={{color:"#A6A5A5",fontSize:16,fontFamily:"DMSans-Light",marginTop:16,textAlign:"center"}}>Login with your phone number</Text>
        </View>
        <View style={{flexDirection:"row",alignItems:"center",marginRight:24}}>
          ...
          <View style={{flex:2.5}}>
            <View style={{flexDirection:"row",alignItems:"center",borderColor:"#EAEAEA",borderWidth:1,borderRadius:10,paddingHorizontal:16}}>
              ...
              <TextInput onChangeText={setPhone}  keyboardType="phone-pad" maxLength={10} textContentType="telephoneNumber" style={{color:"#000",fontFamily:"Quantico-Bold",fontSize:16,width:166,marginLeft:4}} />
            </View>
          </View>
        </View>
        <Error/>
        <View style={{width:"100%",paddingHorizontal:24,marginTop:20}}>
          <TouchableOpacity onPress={HandlePhone} style={{backgroundColor:"#7974B3",padding:16,borderRadius:10}}>
            <Text style={{textAlign:"center",color:"#fff",fontFamily:"DMSans-Medium",fontSize:16}}>Join Now</Text>
          </TouchableOpacity>
        </View>
        <View style={{marginTop:16,flexDirection:"row",alignItems:"center"}}>
          <Text style={{color:"#A6A5A5",fontFamily:"DMSans-Medium",fontSize:14}}>don't have a account?</Text>
          <TouchableOpacity onPress={() => navigation.navigate('Signup')} ><Text style={{color:"#3935AB",fontFamily:"DMSans-Medium",fontSize:14,marginLeft:4}}>Create an Account</Text></TouchableOpacity>
        </View>
      </SafeAreaView>
    )
  }
